...
# lists is appended with each for loop.
username = []
password = []
...
# If indexes are matching menu is displayed. Relevant output is printed if any or both
# details entered are incorrect. User is continously asked to enter username
# and password.
...
if username_input in username and password_input in password:
        ...
        if username_index == password_index:
            print("\nYou have sucesfully logged into the Task Manager. \n")
else:
    print("\nDetails entered are not matching, please try again. \n")
    username_input = input("Please enter your login: ").lower()
    password_input = input ("Please enter your password: ").lower()
    while password_input not in password:
        print ("\nPassword entered is not recognised, please try again: \n")
        username_input = input("Please enter your login: ").lower()
        password_input = input ("Please enter your password: ").lower()
        if username_input in username and password_input in password:
            print("\nYou have sucesfully logged into the Task Manager. \n")
    ...
    while username_input not in username:
        print ("\nUsername is not recognised, plase try again: \n")
        username_input = input("Please enter your login: ").lower()
        password_input = input ("Please enter your password: ").lower()
        if username_input in username and password_input in password:
            print("\nYou have sucesfully logged into the Task Manager. \n")
        i+=1
    while username_input not in username and password_input not in password:
        print("Details entered cannot be found in our databse, please try again. \n")
        i+=1
...
def reg_user ():
    ...
    while reg_username in username:
        print("\nThis username already exists, please add different user\n")
        reg_username = input("Please input new username: ")
...
# looks for 'admin' user input. 'r','ds' and 'gr' functions
